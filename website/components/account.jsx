        ...
        <div className="absolute text-white [background:linear-gradient(180deg,rgb(15.51,0,31.01)_0%,rgb(0.32,21.28,95.61)_100%)] w-[50%] h-[500px] rounded-[5px] pt-[30px] pl-[5%]">
            <div className="w-[100%]">
                ...
                <div>
                    ...
                    <div className="name w-[90%] bg-white bg-opacity-5 p-3 rounded-[5px]">Loading...</div>
                </div>
                <div>
                    <div className="sm:text-2xl text-[16px]">Account information</div>
                    <label className="opacity-75">Email</label>
                    <div className="email w-[90%] bg-white bg-opacity-5 p-3 rounded-[5px]">Loading...</div>
                    <label className="opacity-75">Password</label>
                    <div className="password w-[90%] bg-white bg-opacity-5 p-3 rounded-[5px]">Loading...</div>
                </div>
                <div>
                    <div className="sm:text-2xl text-[16px]">Balance</div>
                    <div className="balance w-[90%] bg-white bg-opacity-5 p-3 rounded-[5px]">Loading...</div>
                    
                </div>    
            </div>
            <div className="absolute bottom-[20px] right-[5%] text-white flex gap-4">
                ...
                <button className="bg-[#FF0000] sm:px-5 px-2 py-2 rounded-[5px] text-[10px] sm:text-[16px]">Delete Account</button>
            </div>
        </div>
        </div>
    </div>
